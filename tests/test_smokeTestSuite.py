...
class TestSmokeTestSuite():
  ...
  def test_adminPageTest(self):
    ...
    self.driver.find_element(By.ID, "username").send_keys("r")
    self.driver.find_element(By.ID, "password").click()
    self.driver.find_element(By.ID, "password").send_keys("r")
  ...
  def test_joinPageTest(self):
    ...
    self.driver.find_element(By.NAME, "lname").send_keys("Bob")
    self.driver.find_element(By.NAME, "bizname").send_keys("Bob")
    self.driver.find_element(By.NAME, "biztitle").send_keys("Bob")
